...
- [Whisper by Remskill](https://whisper.remskill.com) - System-wide dictation app for macOS and Windows; transcribes locally with Whisper or NVIDIA Parakeet, with optional OpenAI cloud mode. (Freemium)
